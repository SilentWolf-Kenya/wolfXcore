...
use Pterodactyl\Console\Commands\Maintenance\ExpireServersCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        $schedule->command(ExpireServersCommand::class)->daily()
            ->appendOutputTo(storage_path('logs/expire-servers.log'));
        ...
        if (config('wolfxcore.telemetry.enabled')) {
