...
class FindAssignableAllocationService
{
    ...
    {
        if (!config('wolfxcore.client_features.allocations.enabled')) {
    ...
    {
        $start = config('wolfxcore.client_features.allocations.range_start', null);
        $end = config('wolfxcore.client_features.allocations.range_end', null);
