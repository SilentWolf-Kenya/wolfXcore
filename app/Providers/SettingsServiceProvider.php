...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'wolfxcore:guzzle:timeout',
        'wolfxcore:guzzle:connect_timeout',
        'wolfxcore:console:count',
        'wolfxcore:console:frequency',
        'wolfxcore:auth:2fa_required',
        'wolfxcore:client_features:allocations:enabled',
