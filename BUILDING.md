# Local Development
wolfXcore is now powered by React, Typescript, and Tailwindcss using webpack at its core to generate compiled assets.
Release versions of wolfXcore will include pre-compiled, minified, and hashed assets ready-to-go.
...
The command above will download all of the dependencies necessary to get wolfXcore assets building. After that, its as
...
the asset URLs used in wolfXcore.

#### Development Environment
If you're using the [`wolfxcore/development`](https://github.com/wolfxcore/development) environments, which are
