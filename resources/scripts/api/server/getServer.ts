...
export interface Server {
    ...
    /**
     * wolfXcore: bot-stability health envelope. Populated server-side by ServerTransformer.
     * Drives the "needs attention" banner in the server console for owners.
     */
    wxnHealth?: {
        paused: boolean;
        ...
        session_restores: number;
        last_session_restore_at: string | null;
    };
}
...
export const rawDataToServerObject = ({ attributes: data }: FractalResponseData): Server => ({
    ...
    wxnHealth: data.wxn_health ?? undefined,
});
