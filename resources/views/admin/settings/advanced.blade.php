...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for wolfXcore.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="wolfxcore:guzzle:connect_timeout" value="{{ old('wolfxcore:guzzle:connect_timeout', config('wolfxcore.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="wolfxcore:guzzle:timeout" value="{{ old('wolfxcore:guzzle:timeout', config('wolfxcore.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="wolfxcore:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('wolfxcore:client_features:allocations:enabled', config('wolfxcore.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="wolfxcore:client_features:allocations:range_start" value="{{ old('wolfxcore:client_features:allocations:range_start', config('wolfxcore.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="wolfxcore:client_features:allocations:range_end" value="{{ old('wolfxcore:client_features:allocations:range_end', config('wolfxcore.client_features.allocations.range_end')) }}">
