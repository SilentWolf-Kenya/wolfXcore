...
// WolfXcore notifications + plans
Route::prefix('/wxn')->group(function () {
    Route::get('/notifications', [Client\WxnNotificationController::class, 'index']);
    Route::post('/notifications/read-all', [Client\WxnNotificationController::class, 'markAllRead']);
    Route::post('/notifications/{id}/read', [Client\WxnNotificationController::class, 'markRead']);
    Route::get('/plans', [Client\WxnPlanController::class, 'index']);
});
...
Route::group([
    ...
    Route::group(['prefix' => '/files'], function () {
        ...
        // Tight throttle — clone-repo is heavy (panel-side download + Wings pull + extraction)
        Route::middleware(['throttle:5,1'])
            ->post('/clone-repo', [Client\Servers\FileController::class, 'cloneRepo']);
